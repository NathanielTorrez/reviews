...
let seedRatings = () => {
  ...
  for (var i = 1; i < 101; i++) {
    ...
    db.query(`INSERT INTO ratings(cleanliness, accuracy, communication, _checkin, _location, _value, rating, home_id) VALUES(${cleanliness}, ${accuracy}, ${communication}, ${_checkin}, ${_location}, ${_value}, ${rating}, ${home_id});`, (err) => {
      if (err) {
        console.log(err);
      } else {
        console.log('success');
