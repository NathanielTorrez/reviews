...
CREATE TABLE reviews (ID int PRIMARY KEY AUTO_INCREMENT, review_text Varchar(1000), user int, home_id int, fullDate  Date, host_response_id int, FOREIGN KEY (user) REFERENCES users(ID)  );
